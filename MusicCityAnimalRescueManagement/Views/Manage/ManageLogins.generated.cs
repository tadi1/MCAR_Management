...
namespace ASP
{
    ...
    public partial class _Views_Manage_ManageLogins_cshtml : System.Web.Mvc.WebViewPage<MusicCityAnimalRescueManagement.Models.ManageLoginsViewModel>
    {
...
, Tuple.Create(Tuple.Create("", 1750), Tuple.Create("Remove", 1750), true)
, Tuple.Create(Tuple.Create(" ", 1756), Tuple.Create("this", 1757), true)
            
            #line 40 "..\..\Views\Manage\ManageLogins.cshtml"
                                          , Tuple.Create(Tuple.Create(" ", 1761), Tuple.Create<System.Object, System.Int32>(account.LoginProvider
            
            #line default
            #line hidden
, 1762), false)
, Tuple.Create(Tuple.Create(" ", 1784), Tuple.Create("login", 1785), true)
, Tuple.Create(Tuple.Create(" ", 1790), Tuple.Create("from", 1791), true)
, Tuple.Create(Tuple.Create(" ", 1795), Tuple.Create("your", 1796), true)
, Tuple.Create(Tuple.Create(" ", 1800), Tuple.Create("account", 1801), true)
);
...
WriteAttribute("id", Tuple.Create(" id=\"", 2646), Tuple.Create("\"", 2672)
            
            #line 63 "..\..\Views\Manage\ManageLogins.cshtml"
, Tuple.Create(Tuple.Create("", 2651), Tuple.Create<System.Object, System.Int32>(p.AuthenticationType
...
WriteAttribute("value", Tuple.Create(" value=\"", 2689), Tuple.Create("\"", 2718)
            
            #line 63 "..\..\Views\Manage\ManageLogins.cshtml"
                                        , Tuple.Create(Tuple.Create("", 2697), Tuple.Create<System.Object, System.Int32>(p.AuthenticationType
...
WriteAttribute("title", Tuple.Create(" title=\"", 2719), Tuple.Create("\"", 2763)
, Tuple.Create(Tuple.Create("", 2727), Tuple.Create("Log", 2727), true)
, Tuple.Create(Tuple.Create(" ", 2730), Tuple.Create("in", 2731), true)
, Tuple.Create(Tuple.Create(" ", 2733), Tuple.Create("using", 2734), true)
, Tuple.Create(Tuple.Create(" ", 2739), Tuple.Create("your", 2740), true)
            
            #line 63 "..\..\Views\Manage\ManageLogins.cshtml"
                                                                                       , Tuple.Create(Tuple.Create(" ", 2744), Tuple.Create<System.Object, System.Int32>(p.Caption
            
            #line default
            #line hidden
, 2745), false)
, Tuple.Create(Tuple.Create(" ", 2755), Tuple.Create("account", 2756), true)
);
